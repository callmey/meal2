...
public class Modify_Menu_Server {
	...
	public void modify(String check_menuName, String change_cuisinetype, String change_mealName, String change_mealPrice, String change_maxcount) {
		...
		try {
			...
			if (rs != null) try { rs.close();System.out.println("醫�猷�1"); } catch(SQLException ex) {}
			if (pstmt != null) try { pstmt.close(); System.out.println("醫�猷�2");} catch(SQLException ex) {}
			if (conn != null) try { conn.close();System.out.println("醫�猷�3"); } catch(SQLException ex) {}
		}
